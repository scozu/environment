...
## Git Safety
- Only create commits or push when explicitly asked by the user or when the `/push` custom command is invoked.
- Never force push, amend, or bypass hooks unless explicitly requested.
